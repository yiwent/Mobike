package com.yiwen.mobike.qrcode;
...
import com.yiwen.mobike.qrcode.zxing.decoding.CaptureActivityHandler;
import com.yiwen.mobike.qrcode.zxing.decoding.InactivityTimer;
import com.yiwen.mobike.qrcode.zxing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
    ...
    protected void initView() {
        ...
        backIbtn = (TabTitleView) findViewById(R.id.title_qrscan);
        viewfinderView = (ViewfinderView) findViewById(R.id.viewfinder_view);
        flashIbtn = (ImageButton) findViewById(R.id.flash_ibtn);
        bt_input = (ImageButton) findViewById(R.id.bt_input);

        backIbtn.setOnLeftButtonClickListener(new TabTitleView.OnLeftButtonClickListener() {
            @Override
            public void onClick() {
                mActivity.finish();
            }
