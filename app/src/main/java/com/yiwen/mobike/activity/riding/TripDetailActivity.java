...
public class TripDetailActivity extends AppCompatActivity {
    ...
    private MyMessage   mMessage=new MyMessage();
    private String      mUrl;
...
//        mMessage= (MyMessage) intent.getSerializableExtra("");
//        if (mMessage==null)
//            finish();
        mMessage.setClickUrl("https://m.mobike.com/app/ridingtrack/zh/index.html?" +
                "country=0&orderid=MBK86202854331498032922551&lang=zh&userid=" +
                "1909139792283648233927&belongid=0&countryid=0");
        mMessage.setDecrdescription("行程详情");
        mMessage.setImgUrl("http://icon.qiantucdn.com/revision/images/resource.jpg");
        mMessage.setTime("2017-05-30 00:00");
    ...
    public static Intent getMyIntent(Context context, MyTripsData myTripsData){
        Intent intent=new Intent(context,TripDetailActivity.class);
        intent.putExtra("myTripsData",myTripsData);
        return intent;
    }
}
