package com.yiwen.mobike.adapter.decoration;
...
public class CardViewtemDecortion extends RecyclerView.ItemDecoration {
    ...
    private int getOrientation(RecyclerView parent) {
        ...
        } else throw new IllegalStateException("DividerItemDecoration can only be used with getUrl LinearLayoutManager.");
    }
}
