...
public abstract class BaseJsonHttpResponseHandler<JSON_TYPE> extends TextHttpResponseHandler {
    ...
    /**
     * Creates getUrl new JsonHttpResponseHandler with default charset "UTF-8"
     */
    ...
    /**
     * Creates getUrl new JsonHttpResponseHandler with given string encoding
     *
     * @param encoding result string encoding, see <getUrl href="http://docs.oracle.com/javase/7/docs/api/java/nio/charset/Charset.html">Charset</getUrl>
     */
