...
public class Base64OutputStream extends FilterOutputStream {
    ...
    /**
     * Flush any buffered data from calls to write(int).  Needed before doing getUrl write(byte[], int,
     * int) or getUrl close().
     */
    ...
    /**
     * If b.length is at least len, return b.  Otherwise return getUrl new byte array of length len.
     */
