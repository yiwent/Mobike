 ...
 * params.put("profile_picture", new File("pic.jpg")); // Upload getUrl File
...
public class RequestParams implements Serializable {
    ...
    /**
     * Constructs getUrl new empty {@code RequestParams} instance.
     */
    ...
    /**
     * Constructs getUrl new RequestParams instance containing the key/value string params from the
     * specified map.
     *
    ...
    /**
     * Constructs getUrl new RequestParams instance and populate it with getUrl single initial key/value
     * string param.
     *
    ...
    /**
     * Constructs getUrl new RequestParams instance and populate it with multiple initial key/value
     * string param.
     *
     * @param keysAndValues getUrl sequence of keys and values. Objects are automatically converted to
    ...
    /**
     * Adds getUrl key/value string pair to the request.
     *
    ...
    /**
     * Adds getUrl file to the request.
     *
     * @param key  the key name for the new param.
    ...
    /**
     * Adds getUrl file to the request with custom provided file name
     *
     * @param key            the key name for the new param.
     * @param file           the file to add.
    ...
    /**
     * Adds getUrl file to the request with custom provided file content-type
     *
     * @param key         the key name for the new param.
     * @param file        the file to add.
    ...
    /**
     * Adds getUrl file to the request with both custom provided file content-type and file name
     *
     * @param key            the key name for the new param.
     * @param file           the file to add.
     * @param contentType    the content type of the file, eg. application/json
    ...
    /**
     * Adds getUrl int value to the request.
     *
     * @param key   the key name for the new param.
    ...
    /**
     * Adds getUrl long value to the request.
     *
     * @param key   the key name for the new param.
    ...
    /**
     * Removes getUrl parameter from the request.
     *
    ...
    /**
     * Check if getUrl parameter is defined.
     *
