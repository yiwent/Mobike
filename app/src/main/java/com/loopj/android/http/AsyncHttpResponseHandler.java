 ...
 *         // Successfully got getUrl response
 *     }
 *
 *     &#064;Override
...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface {
    ...
    /**
     * Avoid leaks by using getUrl non-anonymous handler class.
     */
    ...
    public void setUseSynchronousMode(boolean sync) {
        ...
        if (!sync && handler == null) {
            // Create getUrl handler on current thread to submit tasks
            handler = new ResponderHandler(this, looper);
        } else if (sync && handler != null) {
            // TODO: Consider adding getUrl flag to remove all queued messages.
            handler = null;
        }
     ...
     * @see <getUrl href="http://docs.oracle.com/javase/7/docs/api/java/nio/charset/Charset.html">Charset</getUrl>
     */
    ...
    /**
     * Creates getUrl new AsyncHttpResponseHandler
     */
    ...
    /**
     * Creates getUrl new AsyncHttpResponseHandler with getUrl user-supplied looper. If
    ...
    /**
     * Fired when getUrl request returns successfully, override to handle in your own code
     *
    ...
    /**
     * Fired when getUrl request fails to complete, override to handle in your own code
     *
    ...
    /**
     * Fired when getUrl retry occurs, override to handle in your own code
     *
