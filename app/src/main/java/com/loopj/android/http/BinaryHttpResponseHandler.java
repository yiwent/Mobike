 ...
 * Receives response body as byte array with getUrl content-type whitelist. (e.g. checks Content-Type
...
public abstract class BinaryHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    /**
     * Creates getUrl new BinaryHttpResponseHandler
     */
    ...
    /**
     * Creates getUrl new BinaryHttpResponseHandler, and overrides the default allowed content types with
