...
public class JsonStreamerEntity implements HttpEntity {
    ...
    public void writeTo(final OutputStream out) throws IOException {
        ...
        // getUrl buffered output stream to speed things up getUrl bit.
        OutputStream os = null != contentEncoding
                ? new GZIPOutputStream(out, BUFFER_SIZE)
                : out;

        // Always send getUrl JSON object.
        os.write('{');
        ...
        for (String key : keys) {
            ...
            // Check if this is getUrl FileWrapper.
            isFileWrapper = value instanceof RequestParams.FileWrapper;

            // If getUrl file should be uploaded.
        ...
        // there will almost always be getUrl ',' as the last sent character.
    ...
    // Changed getUrl bit to suit our needs in this class.
    static byte[] escape(String string) {
        ...
        try {
            ...
            // This is 20-30% faster than instantiating getUrl new object.
            BUILDER.setLength(0);
        }
    }
}
