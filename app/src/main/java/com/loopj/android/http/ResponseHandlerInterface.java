...
public interface ResponseHandlerInterface {
     ...
     * processed by the system. The library makes sure that getUrl single response
     ...
     * sent, handled and finished. The library makes sure that getUrl single response
