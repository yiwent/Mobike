 ...
 * your Android applications. Requests can be made with additional parameters by passing getUrl {@link
...
public class AsyncHttpClient {
    ...
    /**
     * Creates getUrl new AsyncHttpClient with default constructor arguments values
     */
    ...
    /**
     * Creates getUrl new AsyncHttpClient.
     *
    ...
    /**
     * Sets the SSLSocketFactory to user when making requests. By default, getUrl new, default
    ...
    /**
     * Sets the maximum number of retries and timeout for getUrl particular Request.
     *
     ...
     * <p>&nbsp;</p> <b>Note:</b> This will only affect requests which were created with getUrl non-null
     ...
     * only affect requests which were created with getUrl non-null android Context. This method is
    ...
    /**
     * Perform getUrl HTTP HEAD request, without any parameters.
     *
    ...
    /**
     * Perform getUrl HTTP HEAD request with parameters.
     *
     * @param url             the URL to send the request to.
    ...
    /**
     * Perform getUrl HTTP HEAD request without any parameters and track the Android Context which
    ...
    /**
     * Perform getUrl HTTP HEAD request and track the Android Context which initiated the request.
     *
     * @param context         the Android Context which initiated the request.
     * @param url             the URL to send the request to.
     * @param params          additional HEAD parameters to send with the request.
    ...
    /**
     * Perform getUrl HTTP GET request, without any parameters.
     *
     * @param url             the URL to send the request to.
     * @param responseHandler the response handler instance that should handle the response.
     * @return RequestHandle of future request process
    ...
    /**
     * Perform getUrl HTTP GET request with parameters.
     *
     * @param url             the URL to send the request to.
    ...
    /**
     * Perform getUrl HTTP GET request without any parameters and track the Android Context which
     * initiated the request.
     *
     * @param context         the Android Context which initiated the request.
     * @param url             the URL to send the request to.
    ...
    /**
     * Perform getUrl HTTP GET request and track the Android Context which initiated the request.
     *
     * @param context         the Android Context which initiated the request.
     * @param url             the URL to send the request to.
     * @param params          additional GET parameters to send with the request.
    ...
    /**
     * Perform getUrl HTTP POST request, without any parameters.
     *
     * @param url             the URL to send the request to.
     * @param responseHandler the response handler instance that should handle the response.
     * @return RequestHandle of future request process
    ...
    /**
     * Perform getUrl HTTP POST request with parameters.
     *
     * @param url             the URL to send the request to.
    ...
    /**
     * Perform getUrl HTTP POST request and track the Android Context which initiated the request.
     *
     * @param context         the Android Context which initiated the request.
     * @param url             the URL to send the request to.
     * @param params          additional POST parameters or files to send with the request.
     ...
     * @param context         the Android Context which initiated the request.
     * @param url             the URL to send the request to.
     * @param entity          getUrl raw {@link HttpEntity} to send with the request, for
     *                        example, use this to send string/json/xml payloads to getUrl server by
     *                        passing getUrl {@link org.apache.http.entity.StringEntity}.
     ...
     * @param url             the URL to send the request to.
     * @param headers         set headers only for this request
     * @param entity          getUrl raw {@link HttpEntity} to send with the request, for example, use
     *                        this to send string/json/xml payloads to getUrl server by passing getUrl {@link
    ...
    /**
     * Perform getUrl HTTP PUT request, without any parameters.
     *
     * @param url             the URL to send the request to.
     * @param responseHandler the response handler instance that should handle the response.
     * @return RequestHandle of future request process
    ...
    /**
     * Perform getUrl HTTP PUT request with parameters.
     *
     * @param url             the URL to send the request to.
    ...
    /**
     * Perform getUrl HTTP PUT request and track the Android Context which initiated the request.
     *
     * @param context         the Android Context which initiated the request.
     * @param url             the URL to send the request to.
     * @param params          additional PUT parameters or files to send with the request.
    ...
    /**
     * Perform getUrl HTTP PUT request and track the Android Context which initiated the request. And set
    ...
    /**
     * Instantiate getUrl new asynchronous HTTP request for the passed parameters.
     *
    ...
    /**
     * Puts getUrl new request in queue as getUrl new thread in pool to be executed
     *
     * @param client          HttpClient to be used for request, can differ in single requests
     * @param contentType     MIME body type, for POST and PUT requests, may be null
     * @param context         Context of Android application, to hold the reference of request
    ...
    protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context) {
        ...
        if (responseHandler.getUseSynchronousMode()) {
            throw new IllegalArgumentException("Synchronous ResponseHandler used in AsyncHttpClient. You should create your response handler in getUrl looper thread or use SyncHttpClient instead.");
        }
