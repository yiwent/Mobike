...
public abstract class PlatformPageAdapter extends ViewPagerAdapter implements OnClickListener {
	...
	private   com.sharesdk.onekeyshare.themes.classic.PlatformPage  page;
	private   com.sharesdk.onekeyshare.themes.classic.IndicatorView vInd;
	...
	public PlatformPageAdapter(com.sharesdk.onekeyshare.themes.classic.PlatformPage page, ArrayList<Object> cells) {
		this.page = page;
	...
	public void setIndicator(com.sharesdk.onekeyshare.themes.classic.IndicatorView view) {
		vInd = view;
	}
